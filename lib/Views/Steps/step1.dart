...
backgroundColor: Color.fromRGBO(255, 255, 254, 1),
    body: Center(
      child: Padding(
        padding:  EdgeInsets.only(left:MediaQuery.of(context).size.width*0.02,right:MediaQuery.of(context).size.width*0.02,top: 10.0 ),
...
customFields("First name", "Enter your first name",null),
            SizedBox(height: 10.0,),


customFields("Last name", "Enter your Last name",null),
            SizedBox(height: 10.0,),

customFields("Date Of birth", "e.g 18/23/2022",Icon(Icons.calendar_today)),
            SizedBox(height: 10.0,),

customFields("Email", "email@gmail.com",null),
            SizedBox(height: 10.0,),
